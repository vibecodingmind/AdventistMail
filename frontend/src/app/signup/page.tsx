  ...
  const googleSignup = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        ...
        // If pending verification, still show success
        setStep('success');
      } finally {
          ...
          {hasGoogleClientId && (
            <div className="mt-4">
              ...
              <button
                ...
                className="w-full py-2.5 flex items-center justify-center gap-3 border border-white/20 rounded-full text-sm text-[#e8eaed]/70 hover:border-white/40 hover:text-[#e8eaed] transition-colors disabled:opacity-50"
              >
